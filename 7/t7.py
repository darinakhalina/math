...
# Як бачимо, для рівномірного розподілу, усі стовпці гістограми мають приблизно однакову висоту, що вказує на рівномірний розподіл даних у всьому діапазоні (ймовірності всіх подій однакові).
